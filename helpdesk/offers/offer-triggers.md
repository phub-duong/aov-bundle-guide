...
description: "Learn how to configure trigger conditions to control which products and customers see your bundle offers."
---

# Set Offer Trigger Conditions

Configure trigger conditions to control when and where your bundle offers appear. Target specific products, collections, or customer segments to maximize offer relevance.

> **Info:** **Prerequisites:** AOV Bundle installed with at least one offer created.

## Overview

Trigger conditions determine which product pages display your offer widget. You can trigger offers based on specific products, entire collections, or cart conditions. Available trigger options vary by offer type.

## Steps

### Step 1: Open an offer for editing
...
Click the **Trigger condition** dropdown to select how the offer is triggered:
- **Specific products** — Choose individual products that display this offer
