...
<Callout type="info">
  **Prerequisites:** AOV Bundle installed and active. Products must already be added to your Shopify store. Note: Bundles are limited in the number of products, options, and variants as per Shopify product limits.
</Callout>
...
![Select Product Fixed Bundle offer type](/images/create-product-fixed-bundle/step-1.png)
...
![Add component products](/images/create-product-fixed-bundle/step-2.png)
...
![Configure pricing](/images/create-product-fixed-bundle/step-3.png)
...
![Set offer information](/images/create-product-fixed-bundle/step-4.png)
...
![Configure advanced settings](/images/create-product-fixed-bundle/step-5.png)
...
<Callout type="info">
  If the bundle contains many variants, creating the offer may take longer than usual. Please wait until the process completes.
</Callout>

![Preview and save](/images/create-product-fixed-bundle/step-6.png)
...
<Cards>
  <Cards.Card
    ...
    href="/docs/design/product-fixed-display"
    arrow
  />
  <Cards.Card
