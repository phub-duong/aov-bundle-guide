...
description: "Learn how to view, activate, pause, duplicate, and delete your bundle offers in AOV Bundle."
---

# Manage Your Offers

View and manage all your bundle offers from one place. Activate, pause, duplicate, or delete offers and filter them by status.

> **Info:** **Prerequisites:** AOV Bundle installed with at least one offer created.

## Overview

The offer list page shows all your offers in a table with their name, type, status, revenue, and actions. You can filter offers by status, search by name, and sort by date.

## Steps

### Step 1: Open the offer list
...
Use the filter bar at the top of the table to filter offers by status. Available filters:
- **All** — Show all offers
- **Active** — Currently live on your store (green badge)
- **Scheduled** — Set to activate in the future (orange badge)
...
Click the **three-dot menu** icon in the Actions column to see additional options:
