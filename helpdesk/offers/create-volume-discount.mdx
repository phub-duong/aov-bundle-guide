...
![Select Volume Discount offer type](/images/create-volume-discount/step-1.png)
...
![Configure trigger conditions](/images/create-volume-discount/step-2.png)
...
![Set up discount tiers](/images/create-volume-discount/step-3.png)
...
![Configure offer widget](/images/create-volume-discount/step-4.png)
...
![Configure advanced settings](/images/create-volume-discount/step-5.png)
...
![Preview and save](/images/create-volume-discount/step-6.png)
...
<Cards>
  <Cards.Card
    ...
    href="/docs/design/volume-display"
    arrow
  />
  <Cards.Card
