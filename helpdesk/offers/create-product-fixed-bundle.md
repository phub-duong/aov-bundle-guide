...
Product Fixed Bundle lets you create a fixed set of products and sell them as a single bundled product in your Shopify store. The bundle appears as its own product listing with a discounted price, and customers can purchase the entire set in one click.

> **Info:** **Prerequisites:** AOV Bundle installed and active. Products must already be added to your Shopify store. Note: Bundles are limited in the number of products, options, and variants as per Shopify product limits.

## Why Product Fixed Bundle?

- **Sell curated sets** — Package complementary products together as a single offering, making it easy for customers to buy everything they need at once.
- **Simplified inventory** — The bundle is managed as a Shopify product with its own variants, pricing, and inventory tracking.
- **Multipack selling** — Allow customers to buy multiple packs of the same bundle with increasing discounts (e.g., 2 packs at 5% off, 3 packs at 10% off).
...
- [Product Fixed Bundle Display Settings](/docs/design/product-fixed-display)
