...
description: "Customize the appearance of the Bundle Builder widget on your storefront in AOV Bundle."
---

# Bundle Builder Display Settings

Customize how the Bundle Builder widget looks on your storefront. Go to **AOV.ai Bundle Discounts > Design > Bundle Builder** to access these settings.

> **Info:** **Prerequisites:** AOV Bundle installed with at least one Bundle Builder offer created.
...
2. **Edit content text**
   - **'Add to Bundle' label**: The button text to add a product to the bundle.
   - **'Out of stock' label**: Text shown when a product is unavailable.
   - **'Add Bundle to cart' label**: The main button to add the complete bundle to cart.
   - **'See details' label** / **'Hide details' label**: Toggle text for product detail views.
   - **'Bundle Summary' label**: Header for the order summary card.
   - **'Subtotal' label** / **'Bundle discount' label** / **Total label**: Labels in the summary card.
   - **'Bundle Item Out Of Stock' label**: Message when a bundle item is out of stock.
   - **Product quantity 'items' label** / **'item' label**: Quantity text.
   - **Discount 'off' label**: Text after the discount value.
   - **Search placeholder**: Placeholder text for the product search field.
   - **No Available Product Label**: Shown when no products match a search.
