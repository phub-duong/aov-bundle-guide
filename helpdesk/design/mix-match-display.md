---
title: "Mix-and-Match Display Settings"
description: "Customize the appearance of the Mix-and-Match Bundle widget on your storefront in AOV Bundle."
---

# Mix-and-Match Display Settings

Customize how the Mix-and-Match Bundle widget looks on your storefront. Go to **AOV.ai Bundle Discounts > Design > Mix-and-Match Bundle** to access these settings.

> **Info:** **Prerequisites:** AOV Bundle installed with at least one Mix-and-Match offer created.
...
2. **Edit content text**
   - **Title**: The main headline on the bundle page. Default: "Design your own ideal pack!"
   - **Description**: A subtitle. Default: "Grab what catches your eye, and we'll sweeten the deal just for you!"
   - **Total products label**: Shows the total selected. Default: "Total products:"
   - **Save badge label**: Shows the discount. Uses `{{discount_value}}` variable.
   - **Promotion message**, **Process message**, **Promotion reached message**: Messages shown during the bundle selection process.
