---
title: "Product Fixed Bundle Display Settings"
description: "Customize the appearance of the Product Fixed Bundle child product list widget on your storefront in AOV Bundle."
---

# Product Fixed Bundle Display Settings

Customize how the child product list widget looks on your storefront. Go to **AOV.ai Bundle Discounts > Design > Child products** to access these settings.

> **Info:** **Prerequisites:** AOV Bundle installed with at least one Product Fixed Bundle offer created.
...
2. **Edit content text**
   - **Saving text**: Text showing the discount amount for the bundle.
   - **Description Label**: The label for the product description.
   - **View More Detail Label**: The link text to expand product details.
